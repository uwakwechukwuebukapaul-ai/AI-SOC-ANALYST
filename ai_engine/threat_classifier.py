...
def classify_threat(case_id):
    ...
    confidence = min(60 + highest_score * 10, 99)
    ...
    return {
        ...
        "matched_keywords": highest_score,
...
def print_report(report):
    ...
    print(f"Threat Type      : {report['classification']}")
    print(f"Confidence       : {report['confidence']}")
    print(f"Keyword Matches  : {report['matched_keywords']}")
